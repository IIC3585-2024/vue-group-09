            ...
            <div class="d-flex flex-column flex-grow-1 pe-8">
              ...
              <div class="d-flex flex-wrap">
                ...
                >
                  ...
                  <!--begin::Label-->
                  <div class="fw-semibold fs-6 text-gray-500">Reservas</div>
                  <!--end::Label-->
                </div>
                <!--end::Stat-->
                ...
                >
                  ...
                  <!--begin::Label-->
                  <div class="fw-semibold fs-6 text-gray-500">Favoritos</div>
                  <!--end::Label-->
                </div>
                <!--end::Stat-->
      ...
      <div class="d-flex overflow-auto h-55px">
        ...
        >
          ...
          <li class="nav-item">
            <router-link
              class="nav-link text-active-primary me-6"
              to="/crafted/pages/profile/bookings"
              active-class="active"
            >
              Mis reservas
            </router-link>
          ...
          <li class="nav-item">
            <router-link
              class="nav-link text-active-primary me-6"
              to="/crafted/pages/profile/favorites"
              active-class="active"
            >
              Mis favoritos
            </router-link>
